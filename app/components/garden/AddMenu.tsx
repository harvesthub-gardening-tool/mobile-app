...
export function AddMenu({ visible, onToggle, onAddPlant, onAddSonde }: AddMenuProps) {
  return (
    <>
      {visible && (
        <View style={styles.menu}>
          <TouchableOpacity style={styles.menuItem} onPress={onAddPlant}>
            <Feather name="feather" size={20} color="#2E7D32" />
            <Text style={styles.menuText}>Plante</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuItem} onPress={onAddSonde}>
